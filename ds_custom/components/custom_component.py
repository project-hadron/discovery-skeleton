...
from ds_custom.intent.custom_intent_model import CustomIntentModel
...
class CustomComponent(AbstractComponent):
    ...
    def from_uri(cls, task_name: str, uri_pm_path: str, creator: str, uri_pm_repo: str=None, pm_file_type: str=None,
        ...
        _pm = CustomPropertyManager(task_name=task_name, creator=creator)
        _intent_model = CustomIntentModel(property_manager=_pm, default_save_intent=default_save_intent,
    ...
    @property
    def pm(self) -> CustomPropertyManager:
        return self._component_pm

    @property
    def intent_model(self) -> CustomIntentModel:
        return self._intent_model

    @property
    def tools(self) -> CustomIntentModel:
        return self._intent_model
